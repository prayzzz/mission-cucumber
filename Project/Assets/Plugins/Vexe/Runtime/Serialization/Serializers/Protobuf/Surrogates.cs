...
namespace Vexe.Runtime.Serialization.Serializers.Protobuf.Surrogates
{
	...
	[ProtoContract]
	public class UnityObjectSurrogate<T> where T : UnityObject
	{
		[ProtoMember(1)]
		public int index;
		public T obj;
		...
		{
			var database = (info.Context as List<UnityObject>);
			index = database.Count;
			database.Add(obj as UnityObject);
		}
