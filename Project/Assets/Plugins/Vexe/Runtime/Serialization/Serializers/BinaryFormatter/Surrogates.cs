...
namespace Vexe.Runtime.Serialization.Serializers.BinaryFormatter.Surrogates
{
	...
	public class UnityObjectSurrogate : ISerializationSurrogate
	{
		public void GetObjectData(object obj, SerializationInfo info, StreamingContext context)
		{
			var database = (context.Context as List<UnityObject>);
		...
		public object SetObjectData(object obj, SerializationInfo info, StreamingContext context, ISurrogateSelector selector)
		{
			return (context.Context as List<UnityObject>)[info.GetInt32("index")];
		}
	}
}