...
namespace Vexe.Runtime.Types.Examples
{
	...
	[DefineCategories("You/Can/Define", "Multiple/Categories", "Like/This")]
	 ...
	 * A:	a) Fields: A visible field is defined as a field that's either public or non public annotated with SerializeField whose type is supported by Unity's serialization system
	 *		b) Property: Any property annotated with [ShowProperty] regardless of access modifier
	 *		c) Method: Any method annotated with [ShowProperty] regardless of access modifier
	 *		
	 ...
	 *		
	 * Q: Can I hide/ignore/undefine a previously defined category?
	 * A: Yes. Use [IgnoreCategories(...)] - All the previously-defined categories specified in the attribute constructor will be ignored
	 * 
	 * Q: I don't like categories, can I display my members in a non-categorized fashion?
	 * A: Yes. Use [UncategorizedView] - like some of the tests do (ShowMethodExample, ShowPropertyTest, etc)
	 */
}