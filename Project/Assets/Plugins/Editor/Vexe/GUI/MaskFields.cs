...
namespace Assets.Plugins.Editor.Vexe.GUI
{
    public partial class GLWrapper
    {
        ...
        public int EnumMaskFieldThatWorks(int currentValue, int[] enumValues, string[] enumNames, GUIContent content)
        {
            ...
            var newMaskVal = this.MaskField(content, maskVal, enumNames);
        ...
        {
            return this.EnumMaskFieldThatWorks(currentValue, enumValues, enumNames, GetContent(text));
        }
        ...
        {
            return this.MaskField(GetContent(label), mask, displayedOptions, style, option);
        }
