...
namespace Assets.Plugins.Editor.Vexe.Other
{
    public static class GUIHelper
    {
        ...
        public static void RegisterFieldForDrag(Object dragObject)
        {
        ...
        /// </summary>
        public static T RegisterFieldForDrop<T>(Rect fieldRect, Func<Object[], Object> getDroppedObject) where T : Object
        {
            Event e = Event.current;
        ...
        public static T RegisterFieldForDrop<T>(Rect fieldRect) where T : Object
        {
        ...
        public static void SelectField(Object obj, MouseCursor cursor = MouseCursor.Link)
        {
            SelectField(GetLastRect(), obj, cursor);
        }
        public static void SelectField(Rect fieldRect, Object obj, MouseCursor cursor = MouseCursor.Link)
        {
            SelectField(fieldRect, obj, LMB_MouseDown(), cursor);
        }
        public static void SelectField(Rect fieldRect, Object obj, bool clickPredicate, MouseCursor cursor = MouseCursor.Link)
        {
            CustomActionField(fieldRect, () => EditorHelper.SelectObject(obj), obj != null, clickPredicate, cursor);
        }
        public static void SelectField(Object obj, bool clickPredicate, MouseCursor cursor = MouseCursor.Link)
        {
            CustomActionField(() => EditorHelper.SelectObject(obj), obj != null, clickPredicate, cursor);
        }
        public static void PingField(Object obj, MouseCursor cursor = MouseCursor.Zoom)
        {
            PingField(GetLastRect(), obj, cursor);
        }
        public static void PingField(Rect fieldRect, Object obj, MouseCursor cursor = MouseCursor.Zoom)
        {
            PingField(fieldRect, obj, obj != null, LMB_MouseDown(), cursor);
        }
        public static void PingField(Rect fieldRect, Object obj, bool showPredicate, bool clickPredicate, MouseCursor cursor = MouseCursor.Zoom)
        {
            CustomActionField(fieldRect, () => EditorHelper.PingObject(obj), showPredicate, clickPredicate, cursor);
        }
        public static void PingField(Rect fieldRect, Object obj, bool showPredicate, MouseCursor cursor = MouseCursor.Zoom)
        {
            PingField(fieldRect, obj, showPredicate, LMB_MouseDown(), cursor);
        }
        public static void PingField(Object obj, bool showPredicate, bool clickPredicate, MouseCursor cursor = MouseCursor.Zoom)
        {
            PingField(GetLastRect(), obj, showPredicate, clickPredicate, cursor);
        }
        public static void PingField(Object obj, bool showPredicate, MouseCursor cursor = MouseCursor.Zoom)
        {
        ...
        public static GUIStyle SelectedStyle
        {
            get
            {
                ...
                {
                    selectedStyle = new GUIStyle(UnityEngine.GUI.skin.textField)
                    {
        ...
        {
            Object.DestroyImmediate(style.normal.background);
        }
        ...
        public static GUIStyle HelpBox
        {
            get
            {
                return RTHelper.LazyValue(() => helpBox, value => helpBox = value, () =>
                    typeof(EditorStyles)
                        .GetProperty("helpBox", BindingFlags.Static | BindingFlags.NonPublic)
        ...
        public static Texture2D GetHelpIcon(MessageType type)
        {
            getHelpIcon = RTHelper.LazyValue(() => getHelpIcon, value => getHelpIcon = value, () =>
                typeof(EditorGUIUtility).GetMethod("GetHelpIcon", BindingFlags.Static | BindingFlags.NonPublic));
